  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light"><a href="index.html">PROYECTO AWS</a></h1>
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="#hero" class="nav-link scrollto active"><i class="bx bx-config"></i> <span>Subir archivo</span></a></li>
          <form action="" method="post" enctype="multipart/form-data">
          <input type="file" name="archivo" id="archivo" style="width:100%"><br><br>
...
<!-- End Services Section -->
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span><?php echo $Date = date("d/m/Y");   ?></span></strong>
      </div>
      <div class="credits">
      </div>
    </div>
