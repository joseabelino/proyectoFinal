...
$qrCodeUrl = $Authenticator->getQR('Proyecto AWS', $_SESSION['auth_secret']);
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3"  style="background: white; padding: 20px; box-shadow: 10px 10px 5px #888888; margin-top: 100px;">
                <h1>Authenticador Google</h1>
                <p style="font-style: italic;">Autenticación de doble factor</p>
                <hr>
                <form action="check.php" method="post">
                    <div style="text-align: center;">
                        <?php if ($_SESSION['failed']): ?>
                            <div class="alert alert-danger" role="alert">
                                <strong>Ocurrio un error </strong>Codigo incorrecto
                            </div>
                            <?php   
                            $_SESSION['failed'] = false;
                            ?>
